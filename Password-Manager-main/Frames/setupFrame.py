...
class SetupFrame(tk.Frame):
	def __init__(self, parent, controller):
		...
		# colors
		self.primaryColor = '#66ccff'
		self.backgroundColor = '#1a1a1a'
		self.surface1Color = '#404040'
		self.surface2Color = '#404040'
		self.successColor = '#03dac6'
		self.errorColor = '#ff3333'
		self.priTextColor = '#ffffff'
		self.secTextColor = '#e6e6e6'
		# fonts
		self.entryFont = ("Rockwell", 12)
		self.labelFont = ("Rockwell", 12, "bold", "italic")
	...
	def insertPass(self, otpStatus):
			...
			try:
				...
				if(otpStatus == True):
					...
					confirmInsertLabel = tk.Label(self.setupFrame, text = "Success", bg = self.successColor, fg = self.priTextColor, font = self.labelFont)
